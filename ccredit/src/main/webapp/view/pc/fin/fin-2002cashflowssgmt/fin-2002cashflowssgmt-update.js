var fin2002cashflowssgmtWinEdit;
var fin2002cashflowssgmtFormEdit;
function updateFin2002cashflowssgmt(){
	var record = grid.getSelectionModel().selected;
	if(record.length == 0){
		msgTishi('请选择要修改的一项！');
		return;
	}
	initFin2002cashflowssgmtFormEdit();
	fin2002cashflowssgmtWinEdit = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximizable:true,
		...
		items:fin2002cashflowssgmtFormEdit,
		buttons:[{
			text:'保存',
			itemId:'save',
			handler:function(button){
				submitForm(fin2002cashflowssgmtFormEdit,'../fin2002cashflowssgmtController/updateFin2002cashflowssgmt',grid,fin2002cashflowssgmtWinEdit,false,true);
			}
		},{
			text:'关闭',
			itemId:'close',
	...
	fin2002cashflowssgmtWinEdit.show();
	
	loadFormData(fin2002cashflowssgmtFormEdit,'../fin2002cashflowssgmtController/getFin2002cashflowssgmtById?fin_2002cashflowssgmt_id='+ record.items[0].data.fin_2002cashflowssgmt_id);
}
function initFin2002cashflowssgmtFormEdit(){
	fin2002cashflowssgmtFormEdit = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
