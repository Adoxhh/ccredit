var fin2002cashflowssgmtWinAdd;
var fin2002cashflowssgmtFormAdd;
function addFin2002cashflowssgmt(){
	initFin2002cashflowssgmtFormAdd();
	fin2002cashflowssgmtWinAdd = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximizable:true,
		...
		items:fin2002cashflowssgmtFormAdd,
		buttons:[{
			text:'保存',
			itemId:'save',
			handler:function(button){
				submitForm(fin2002cashflowssgmtFormAdd,'../fin2002cashflowssgmtController/addFin2002cashflowssgmt',grid,fin2002cashflowssgmtWinAdd,false,true);
			}
		},{
			text:'关闭',
			itemId:'close',
	...
	fin2002cashflowssgmtWinAdd.show();
	
}
function initFin2002cashflowssgmtFormAdd(){
	fin2002cashflowssgmtFormAdd = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
