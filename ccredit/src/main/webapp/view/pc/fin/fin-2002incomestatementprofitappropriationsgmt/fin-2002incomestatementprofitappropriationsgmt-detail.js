var fin2002incomestatementprofitappropriationsgmtWinDetail;
var fin2002incomestatementprofitappropriationsgmtFormDetail;
function detailFin2002incomestatementprofitappropriationsgmt(){
	var record = grid.getSelectionModel().selected;
	if(record.length == 0){
		msgTishi('请选择要查看明细的项！');
		return;
	}
	initFin2002incomestatementprofitappropriationsgmtFormDetail();
	fin2002incomestatementprofitappropriationsgmtWinDetail = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximizable:true,
		...
		items:fin2002incomestatementprofitappropriationsgmtFormDetail,
		buttons:[{
			text:'关闭',
			itemId:'close',
	...
	fin2002incomestatementprofitappropriationsgmtWinDetail.show();
	
	loadFormData(fin2002incomestatementprofitappropriationsgmtFormDetail,'../fin2002incomestatementprofitappropriationsgmtController/getFin2002incomestatementprofitappropriationsgmtById?fin_2002incomestatementprofitappropriationsgmt_id='+ record.items[0].data.fin_2002incomestatementprofitappropriationsgmt_id);
}
function initFin2002incomestatementprofitappropriationsgmtFormDetail(){
	fin2002incomestatementprofitappropriationsgmtFormDetail = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
