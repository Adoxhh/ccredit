var fin2007cashflowssgmtWinAdd;
var fin2007cashflowssgmtFormAdd;
function addFin2007cashflowssgmt(){
	initFin2007cashflowssgmtFormAdd();
	fin2007cashflowssgmtWinAdd = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximizable:true,
		...
		items:fin2007cashflowssgmtFormAdd,
		buttons:[{
			text:'保存',
			itemId:'save',
			handler:function(button){
				submitForm(fin2007cashflowssgmtFormAdd,'../fin2007cashflowssgmtController/addFin2007cashflowssgmt',grid,fin2007cashflowssgmtWinAdd,false,true);
			}
		},{
			text:'关闭',
			itemId:'close',
	...
	fin2007cashflowssgmtWinAdd.show();
	
}
function initFin2007cashflowssgmtFormAdd(){
	fin2007cashflowssgmtFormAdd = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
