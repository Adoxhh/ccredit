var fin2007cashflowssgmtWinDetail;
var fin2007cashflowssgmtFormDetail;
function detailFin2007cashflowssgmt(){
	var record = grid.getSelectionModel().selected;
	if(record.length == 0){
		msgTishi('请选择要查看明细的项！');
		return;
	}
	initFin2007cashflowssgmtFormDetail();
	fin2007cashflowssgmtWinDetail = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximizable:true,
		...
		items:fin2007cashflowssgmtFormDetail,
		buttons:[{
			text:'关闭',
			itemId:'close',
	...
	fin2007cashflowssgmtWinDetail.show();
	
	loadFormData(fin2007cashflowssgmtFormDetail,'../fin2007cashflowssgmtController/getFin2007cashflowssgmtById?fin_2007cashflowssgmt_id='+ record.items[0].data.fin_2007cashflowssgmt_id);
}
function initFin2007cashflowssgmtFormDetail(){
	fin2007cashflowssgmtFormDetail = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
